...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || "target.wast";
  var wasmBinaryFile = Module['wasmBinaryFile'] || "target.wasm";
  var asmjsCodeFile = Module['asmjsCodeFile'] || "target.asm.js";
...
gb = Runtime.alignMemory(getMemory(16, 4 || 1));

// STATICTOP = STATIC_BASE + 16;
  /* global initializers */  __ATINIT__.push();
  

/* memory initializer */ allocate([37,100,0], "i8", ALLOC_NONE, gb);
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "setTempRet0": setTempRet0, "getTempRet0": getTempRet0, "_printf": _printf, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "gb": gb, "fb": fb };
